...
bad_words = ["US Citizen", "USA Citizen", "US Citizenship", "Security Clearance", "No C2C", "No Corp2Corp", "H1B sponsorship", "Visa sponsorship", ".NET", "Embedded Programming", "PHP", "Ruby", "CNC"]   # Case Insensitive. India-focused: skip US-only and tech stacks you don't prefer
